...
///
/// ```no_run
/// # fn example(supervisor: &mut batter_core::lifecycle::Supervisor) -> Result<(), batter_core::lifecycle::SignalRegistrationError> {
/// batter_core::lifecycle::register_signals(supervisor, "signals")?;
/// # Ok(()) }
/// ```
...
///
/// ```no_run
/// # use batter_core::{cleanup::CleanupBudget, lifecycle::{ShutdownBudget, Supervisor, install_signals}};
