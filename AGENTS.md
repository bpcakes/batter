...
This workspace contains six library packages and two SQLx example packages,
with failure-contract tests, doctests, and seven runnable demonstrations plus a
