...
- [x] (2026-09-12 14:29Z) Verified completed predecessor batter-lp2.1 and retained its protected types and compatibility fixtures.
- [x] (2026-09-12 15:01Z) Added inert policy configuration, precedence and private name reservation.
- [x] (2026-09-12 15:18Z) Integrated synchronous installation and retained preflight failures into the single driver.
- [x] (2026-09-12 15:18Z) Preserved reception through initialization, destruction and running handoff.
- [x] (2026-09-12 15:42Z) Executed real Unix process scenarios and deterministic injected-error controls.
- [x] (2026-09-12 16:03Z) Completed docs, both-toolchain verification, ten HTTP smokes and final Jig evidence (`receipt_01M2B1K8CHDKZCE819555ABVFW`).
...
Implementation now installs selected native listeners synchronously, reserves
their component identity before application work, and retains them in the shared
startup coordinator. Linux fresh-process tests cover TERM and INT before the
coordinator first polls, after resource registration, after borrowed-waiter
cancellation, in unapproved and approved running services, and the explicit
unstarted/unconfigured opt-out controls. Injected tests retain installation IO,
unused-capture panic and failed cleanup after immediate owner loss. Both supported
toolchains and all ten HTTP smokes pass. A fresh child installs the first native
source and injects the second installation failure. New macOS/hosted execution
