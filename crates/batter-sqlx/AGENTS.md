...
- `src/profiled_pool.rs`: shared immutable profile and all three native pool hooks.
- `src/atomic_context.rs`: unprofiled/profile-owned runners retain native completion before
