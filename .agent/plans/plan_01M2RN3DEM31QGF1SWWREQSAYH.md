...
This is Jig's initial plan snapshot. The living execution record and final
outcomes are in [the owning task plan](batter-97p-runlimit.md).
...
- [ ] Implement adapter, optional dependencies and constrained observation seam.
- [ ] Port failure scenarios, runnable consumer and independent feature checks.
- [ ] Update contracts, scope/dependent tracker records and validation evidence.
- [ ] Run focused checks, both verification matrices, five HTTP smoke profiles
...
Implementation and production verification are pending. PostgreSQL runtime,
Linux/hosted execution and independent agent usability remain unverified unless
specific evidence is added here and in docs/validation.md.
