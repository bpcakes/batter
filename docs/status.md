...
| Abandoned startup | Implemented | Supervisor owns synchronous signaling from construction and transfers it into the driver; dropping the owner wakes readiness waiters with Draining before capture destruction. No factories/finalizers run and no completion report is fabricated. |
