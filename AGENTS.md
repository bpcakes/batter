...
This workspace contains eight library packages and two SQLx example packages,
...
belong to `batter-uia`. Keep `Cargo.lock` generated by Cargo. Every workspace
package has publishing disabled.
