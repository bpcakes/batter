...
| Abandoned-startup waiter notification, no fabricated completion, guard transfer and component/cleanup capture destruction order, extracted cleanup independent of cancelled operations, inert factories and invalid-name/startup/capacity/closure precedence | [lifecycle_state.rs](../crates/batter/tests/lifecycle_state.rs) |
