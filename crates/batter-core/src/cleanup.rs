...
///
/// ```
/// use batter_core::cleanup::CleanupStack;
...
/// # let budget = batter_core::cleanup::CleanupBudget::new(std::time::Duration::from_secs(1), std::time::Duration::from_secs(1), std::time::Duration::from_secs(1)).unwrap();
